...
pub const DEFAULT_REGISTRY: &str = "adi-chain/cli";
...
/// assert_eq!(config.registry, "adi-chain/cli");
/// ```
...
///
/// assert_eq!(image_ref.full_uri(), "adi-chain/cli/adi-toolkit:v30.0.2");
/// ```
#[derive(Debug, Clone)]
...
mod tests {
    ...
    fn test_tag_override() {
        ...
        assert_eq!(image_ref.full_uri(), "adi-chain/cli/adi-toolkit:custom-tag");
    }
